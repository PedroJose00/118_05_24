...
# Definición del espacio para el tensor, asumiendo que sigma devuelve un tensor de segundo orden
...
with XDMFFile(mesh.comm, "./18_05_24/fem_function_BVTV.xdmf", "w") as file:
...
# ----------------------------------------------------------------------------------
with XDMFFile(mesh.comm, "./18_05_24/fem_function_modulo_E_0.xdmf", "w") as file:
          file.write_mesh(mesh)
          file.write_function(fem_function_modulo_E_f ,0.0)


with XDMFFile(mesh.comm, "./18_05_24/fem_function_densidad_0.xdmf", "w") as file:
          file.write_mesh(mesh)
...
for dmes in range(1, 2):
    ...
    for dday in range(1, 25):  # Ciclo externo con dtime va de 1 a 24
        ...
        for cycle in range(1000, 10001, 1000):  # Ciclo interno va de 1000 en 1000 hasta 10000
            ...
            array_derivative_NBMU = array_Sv * array_rdot *escalar_V_bmu

            expression_array_dot_vr = (1 - array_porosidad) * array_derivative_NBMU * escalar_tmp_ar1 * (t_prima_24 /escalar_TR)**2 *t_prima_24
            ...
            # with XDMFFile(mesh.comm, "./18_05_24/fase_1/fem_function_array_rdot.xdmf", "w") as file:
            #     file.write_mesh(mesh)
            #     file.write_function(fem_function_array_rdot , tmp_cycle)    
            # with XDMFFile(mesh.comm, "./18_05_24/fase_1/fem_function_array_psi.xdmf", "w") as file:
            #     file.write_mesh(mesh)
            #     file.write_function(fem_function_array_psi , tmp_cycle)    
            # with XDMFFile(mesh.comm, "./18_05_24/fase_1/fem_function_array_error.xdmf", "w") as file:
            #     file.write_mesh(mesh)
            #     file.write_function(fem_function_array_error , tmp_cycle)    
            # with XDMFFile(mesh.comm, "./18_05_24/fase_1/fem_function_array_alpha.xdmf", "w") as file:
            #     file.write_mesh(mesh)
    ...
    with XDMFFile(mesh.comm, "./18_05_24/fase_1/fem_function_densidad_fase_1.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_densidad_gr_cm3 , tmp_day)
    with XDMFFile(mesh.comm, "./18_05_24/fase_1/fem_function_BVTV_fase_1.xdmf", "w") as file:
        file.write_mesh(mesh)
...
#---------------------------------------------------------------------------------------------------
    ...
    for dday in range(1, 8):  # Ciclo externo con dtime va de 1 a 8
        ...
        for cycle in range(1000, 10001, 1000):  # Ciclo interno va de 1000 en 1000 hasta 10000
            ...
            expression_array_dot_vr = array_BVTV * array_derivative_NBMU * escalar_tmp_ar1 * t_prima_8/escalar_TR
            fem_function_vr_dot.x.array[:] = expression_array_dot_vr
            ...
            # # ----------------------------------------------------------------------------------------------------------
            # with XDMFFile(mesh.comm, "./18_05_24/fase_2/fem_function_array_modulo.xdmf", "w") as file:
            #     file.write_mesh(mesh)
            #     file.write_function(fem_function_modulo_E_f , tmp_cycle)    
            # with XDMFFile(mesh.comm, "./18_05_24/fase_2/fem_function_array_damage.xdmf", "w") as file:
            #     file.write_mesh(mesh)
            #     file.write_function(fem_function_damage , tmp_cycle)    
            # with XDMFFile(mesh.comm, "./18_05_24/fase_2/fem_function_array_rdot.xdmf", "w") as file:
            #     file.write_mesh(mesh)
            #     file.write_function(fem_function_array_rdot , tmp_cycle)    
            # with XDMFFile(mesh.comm, "./18_05_24/fase_2/fem_function_array_psi.xdmf", "w") as file:
            #     file.write_mesh(mesh)
            #     file.write_function(fem_function_array_psi , tmp_cycle)    
            # with XDMFFile(mesh.comm, "./18_05_24/fase_2/fem_function_array_error.xdmf", "w") as file:
            #     file.write_mesh(mesh)
            #     file.write_function(fem_function_array_error , tmp_cycle)    
    ...
    with XDMFFile(mesh.comm, "./18_05_24/fase_2/fem_function_densidad.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_densidad_gr_cm3 , tmp_day)
    with XDMFFile(mesh.comm, "./18_05_24/fase_2/fem_function_BVTV.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_BVTV , tmp_day)
...
#----------------------------------------------------------------------------------------------
    for dday in range(1, 64):  # Ciclo externo con dtime va de 1 a 64
        ...
        for cycle in range(1000, 10001, 1000):  # Ciclo interno va de 1000 en 1000 hasta 10000
            ...
            expression_array_dot_vb = array_derivative_NBMU * escalar_tmp_af3  * t_prima_64/escalar_TF
            ...
            # # ----------------------------------------------------------------------------------------------------------
            # with XDMFFile(mesh.comm, "./18_05_24/fase_3/fem_function_array_modulo.xdmf", "w") as file:
            #     file.write_mesh(mesh)
            #     file.write_function(fem_function_modulo_E_f , tmp_cycle)    
            
            # with XDMFFile(mesh.comm, "./18_05_24/fase_3/fem_function_array_damage.xdmf", "w") as file:
            #     file.write_mesh(mesh)
            #     file.write_function(fem_function_damage , tmp_cycle)    
            # with XDMFFile(mesh.comm, "./18_05_24/fase_2/fem_function_alpha.xdmf", "w") as file:
            #       file.write_mesh(mesh)
            #       file.write_function(fem_function_alpha , tmp_cycle)    
            # with XDMFFile(mesh.comm, "./18_05_24/fase_3/fem_function_array_rdot.xdmf", "w") as file:
            #     file.write_mesh(mesh)
            #     file.write_function(fem_function_array_rdot , tmp_cycle)    
            # with XDMFFile(mesh.comm, "./18_05_24/fase_3/fem_function_array_psi.xdmf", "w") as file:
            #     file.write_mesh(mesh)
            #     file.write_function(fem_function_array_psi , tmp_cycle)    
            # with XDMFFile(mesh.comm, "./18_05_24/fase_3/fem_function_array_error.xdmf", "w") as file:
            #     file.write_mesh(mesh)
            #     file.write_function(fem_function_array_error , tmp_cycle)    
    ...
    with XDMFFile(mesh.comm, "./18_05_24/fase_3/fem_function_densidad_fase_3.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_densidad_gr_cm3 , tmp_day)
    with XDMFFile(mesh.comm, "./18_05_24/fase_3/fem_function_BVTV_fase_3.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_BVTV , tmp_day)
...
#----------------------------------------------------------------------------------------------
    for dday in range(1, 5):  # Ciclo externo con dtime va de 1 a 5
        ...
        for cycle in range(1000, 10001, 1000):  # Ciclo interno va de 1000 en 1000 hasta 10000
            ...
            expression_array_dot_vr = array_BVTV * array_derivative_NBMU * escalar_tmp_ar2 * t_prima_100/escalar_TR
            expression_array_dot_vb = array_derivative_NBMU * escalar_tmp_af4 * t_prima_100/escalar_TF
            ...
            array_formacion_vb[condicion_trabecular]= array_formacion_vb[condicion_trabecular] + array_derivative_NBMU[condicion_trabecular]/escalar_TF
            array_formacion_vb[condicion_cortical] = array_formacion_vb[condicion_cortical] + expression_array_dot_vb[condicion_cortical] - expression_array_dot_vr[condicion_cortical]
            ...
            # # ----------------------------------------------------------------------------------------------------------
            # with XDMFFile(mesh.comm, "./18_05_24/fase_4/fem_function_modulo.xdmf", "w") as file:
            #     file.write_mesh(mesh)
            #     file.write_function(fem_function_modulo_E_f , tmp_cycle)    
            # with XDMFFile(mesh.comm, "./18_05_24/fase_4/fem_function_densidad_material.xdmf", "w") as file:
            #     file.write_mesh(mesh)
            #     file.write_function(fem_function_densidad_material , tmp_cycle)    
            # with XDMFFile(mesh.comm, "./18_05_24/fase_4/fem_function_BVTV.xdmf", "w") as file:
            #     file.write_mesh(mesh)
            #     file.write_function(fem_function_BVTV , tmp_cycle)    
            # with XDMFFile(mesh.comm, "./18_05_24/fase_4/fem_function_array_modulo.xdmf", "w") as file:
            #     file.write_mesh(mesh)
            #     file.write_function(fem_function_modulo_E_f , tmp_cycle)    
            # with XDMFFile(mesh.comm, "./18_05_24/fase_4/fem_function_array_vm.xdmf", "w") as file:
            #     file.write_mesh(mesh)
            #     file.write_function(fem_function_array_vm , tmp_cycle)    
            # with XDMFFile(mesh.comm, "./18_05_24/fase_4/fem_function_array_damage.xdmf", "w") as file:
            #     file.write_mesh(mesh)
            #     file.write_function(fem_function_damage , tmp_cycle)    
            # with XDMFFile(mesh.comm, "./18_05_24/fase_4/fem_function_alpha.xdmf", "w") as file:
            #      file.write_mesh(mesh)
            #      file.write_function(fem_function_alpha , tmp_cycle)    
            # with XDMFFile(mesh.comm, "./18_05_24/fase_4/fem_function_array_rdot.xdmf", "w") as file:
            #     file.write_mesh(mesh)
            #     file.write_function(fem_function_array_rdot , tmp_cycle)    
            # with XDMFFile(mesh.comm, "./18_05_24/fase_4/fem_function_array_psi.xdmf", "w") as file:
            #     file.write_mesh(mesh)
            #     file.write_function(fem_function_array_psi , tmp_cycle)    
            # with XDMFFile(mesh.comm, "./18_05_24/fase_4/fem_function_array_error.xdmf", "w") as file:
            #     file.write_mesh(mesh)
            #     file.write_function(fem_function_array_error , tmp_cycle)    
    ...
    with XDMFFile(mesh.comm, "./18_05_24/fase_4/fem_function_array_error.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_array_error , tmp_cycle)    
    with XDMFFile(mesh.comm, "./18_05_24/fase_4/fem_function_densidad_fase_4.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_densidad_gr_cm3 , tmp_day)
    with XDMFFile(mesh.comm, "./18_05_24/fase_4/fem_function_BVTV_fase_4.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_BVTV , tmp_day)
...
#-------------------------------------------------------------------------------------------
    for dday in range(1, 7):  # Ciclo externo con dtime va de 1 a 24
        ...
        for cycle in range(1000, 10001, 1000):  # Ciclo interno va de 1000 en 1000 hasta 10000
            ...
            expression_array_dot_vr = (1 - array_porosidad) * array_derivative_NBMU * escalar_tmp_ar5 * t_prima_100_TR/escalar_TR
#            print(f" dentro de la quinta etapa -->> La expression_array_dot_vr: { escalar_tmp_ar5}")
            ...
            array_vm[condicion_trabecular] = (escalar_vm * array_COPY_BVTV[condicion_trabecular] + escalar_vm * array_formacion_vb[condicion_trabecular])/array_BVTV[condicion_trabecular]
            array_vm[condicion_cortical] = (escalar_vm * array_COPY_BVTV[condicion_cortical] + escalar_vm * expression_array_dot_vr[condicion_cortical] + escalar_vm*array_formacion_vb[condicion_cortical])/array_BVTV[condicion_cortical]
...
#            array_modulo_E_f[condicion_cortical]= 84370 * (array_BVTV[condicion_cortical] ** 2.58) * (array_alpha ** 2.74) *1e3
            ...
            # # ----------------------------------------------------------------------------------------------------------
            # with XDMFFile(mesh.comm, "./18_05_24/fase_5/fem_function_modulo.xdmf", "w") as file:
            #     file.write_mesh(mesh)
            #     file.write_function(fem_function_modulo_E_f , tmp_cycle)    
            # with XDMFFile(mesh.comm, "./18_05_24/fase_5/fem_function_densidad_material.xdmf", "w") as file:
            #     file.write_mesh(mesh)
            #     file.write_function(fem_function_densidad_material , tmp_cycle)    
            # with XDMFFile(mesh.comm, "./18_05_24/fase_5/fem_function_array_damage.xdmf", "w") as file:
            #     file.write_mesh(mesh)
            #     file.write_function(fem_function_damage , tmp_cycle)    
            # with XDMFFile(mesh.comm, "./18_05_24/fase_5/fem_function_array_alpha.xdmf", "w") as file:
            #     file.write_mesh(mesh)
            #     file.write_function(fem_function_alpha , tmp_cycle)    
            # with XDMFFile(mesh.comm, "./18_05_24/fase_5/fem_function_array_rdot.xdmf", "w") as file:
            #     file.write_mesh(mesh)
            #     file.write_function(fem_function_array_rdot , tmp_cycle)    
            # with XDMFFile(mesh.comm, "./18_05_24/fase_5/fem_function_array_psi.xdmf", "w") as file:
            #     file.write_mesh(mesh)
            #     file.write_function(fem_function_array_psi , tmp_cycle)    
            # with XDMFFile(mesh.comm, "./18_05_24/fase_5/fem_function_array_error.xdmf", "w") as file:
            #     file.write_mesh(mesh)
            #     file.write_function(fem_function_array_error , tmp_cycle)    
    ...
    with XDMFFile(mesh.comm, "./18_05_24/fase_5/fem_function_densidad_material.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_densidad_material , tmp_cycle)    
    with XDMFFile(mesh.comm, "./18_05_24/fase_5/fem_function_BVTV.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_BVTV , tmp_cycle)    
    with XDMFFile(mesh.comm, "./18_05_24/fase_5/fem_function_array_modulo.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_modulo_E_f , tmp_cycle)    
    with XDMFFile(mesh.comm, "./18_05_24/fase_5/fem_function_array_vm.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_array_vm , tmp_cycle)    
    with XDMFFile(mesh.comm, "./18_05_24/fase_5/fem_function_array_damage.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_damage , tmp_cycle)    
    with XDMFFile(mesh.comm, "./18_05_24/fase_5/fem_function_alpha.xdmf", "w") as file:
         file.write_mesh(mesh)
         file.write_function(fem_function_alpha , tmp_cycle)    
    with XDMFFile(mesh.comm, "./18_05_24/fase_5/fem_function_array_rdot.xdmf", "w") as file:
        file.write_mesh(mesh)
    ...
    with XDMFFile(mesh.comm, "./18_05_24/fase_5/fem_function_array_error.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_array_error , tmp_cycle)    
    with XDMFFile(mesh.comm, "./18_05_24/fase_5/fem_function_densidad_fase_4.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_densidad_gr_cm3 , tmp_day)
    with XDMFFile(mesh.comm, "./18_05_24/fase_5/fem_function_BVTV_fase_4.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_BVTV , tmp_day)
        
    with XDMFFile(mesh.comm, "./18_05_24/fase_5/fem_function_densidad_fase_5.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_densidad_gr_cm3 , tmp_day)
    with XDMFFile(mesh.comm, "./18_05_24/fase_5/fem_function_BVTV_fase_5.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_BVTV , tmp_day)
    print("---------------------------------------------------------")              
    print("El valor promedio de la BVTV es:", promedios_BVTV[escalar_contador_total_dias])
...
# ------------------------------------------------------------------------------------
    print("---------------------------------------------------------")              
    print("El valor promedio de la BVTV es:", promedios_BVTV[escalar_contador_total_dias])
    print(f" Inicia la quinta etapa  18 dias --->> La energía: {energy}")
    print("---------------------------------------------------------")              
    tmp_lenght = escalar_contador_total_dias
    print(f"04-longitud del CSV-->>>>:{tmp_lenght}")
#-------------------------------------------------------------------------------------------
    for dday in range(1, 18):  # Ciclo externo con dtime va de 1 a 24
        escalar_contador_total_dias += 1
        ...
        for cycle in range(1000, 10001, 1000):  # Ciclo interno va de 1000 en 1000 hasta 10000
            ...
            escalar_tmp_ar5 = escalar_tmp_ar2 * (t_prima_100_TR / escalar_TR) ** 2
            expression_array_dot_vr = (1 - array_porosidad) * array_derivative_NBMU * escalar_tmp_ar5 /escalar_TR
#            print(f" dentro de la quinta etapa -->> La expression_array_dot_vr: { escalar_tmp_ar5}")
...
#            array_modulo_E_f[condicion_cortical]= 84370 * (array_BVTV[condicion_cortical] ** 2.58) * (array_alpha ** 2.74) *1e3
    ...
    with XDMFFile(mesh.comm, "./18_05_24/fase_52/fem_function_modulo.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_modulo_E_f , tmp_cycle)    
    with XDMFFile(mesh.comm, "./18_05_24/fase_52/fem_function_densidad_material.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_densidad_material , tmp_cycle)    
    with XDMFFile(mesh.comm, "./18_05_24/fase_52/fem_function_BVTV.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_BVTV , tmp_cycle)    
    with XDMFFile(mesh.comm, "./18_05_24/fase_52/fem_function_array_modulo.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_modulo_E_f , tmp_cycle)    
    with XDMFFile(mesh.comm, "./18_05_24/fase_52/fem_function_array_vm.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_array_vm , tmp_cycle)    
    with XDMFFile(mesh.comm, "./18_05_24/fase_52/fem_function_array_damage.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_damage , tmp_cycle)    
    with XDMFFile(mesh.comm, "./18_05_24/fase_52/fem_function_alpha.xdmf", "w") as file:
         file.write_mesh(mesh)
         file.write_function(fem_function_alpha , tmp_cycle)    
    with XDMFFile(mesh.comm, "./18_05_24/fase_52/fem_function_array_rdot.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_array_rdot , tmp_cycle)    
    with XDMFFile(mesh.comm, "./18_05_24/fase_52/fem_function_array_psi.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_array_psi , tmp_cycle)    
    with XDMFFile(mesh.comm, "./18_05_24/fase_52/fem_function_array_error.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_array_error , tmp_cycle)    
    with XDMFFile(mesh.comm, "./18_05_24/fase_52/fem_function_densidad_fase_52.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_densidad_gr_cm3 , tmp_day)
    with XDMFFile(mesh.comm, "./18_05_24/fase_52/fem_function_BVTV_fase_52.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_BVTV , tmp_day)
    ...
    for dday in range(1, 9):  # Ciclo externo con dtime va de 1 a 32
        ...
        for cycle in range(1000, 10001, 1000):  # Ciclo interno va de 1000 en 1000 hasta 10000
           ...
           # print(f"El valor del escalar de energia [U] en el día {dday} en el ciclo {tmp_cycle} es: {energy}")
            ...
            expression_array_dot_vr = array_derivative_NBMU * escalar_tmp_af4 * t_prima_100_TR_TI/escalar_TR
...
#            array_modulo_E_f[condicion_cortical]= 84370 * (array_BVTV[condicion_cortical] ** 2.58) * (array_alpha ** 2.74) *1e3
            ...
            # ----------------------------------------------------------------------------------------------------------
            # with XDMFFile(mesh.comm, "./18_05_24/fase_6/fem_function_array_modulo.xdmf", "w") as file:
            #     file.write_mesh(mesh)
            #     file.write_function(fem_function_modulo_E_f , tmp_cycle)    
            
            # with XDMFFile(mesh.comm, "./18_05_24/fase_6/fem_function_array_damage.xdmf", "w") as file:
            #     file.write_mesh(mesh)
            #     file.write_function(fem_function_damage , tmp_cycle)    
            # with XDMFFile(mesh.comm, "./18_05_24/fase_2/fem_function_alpha.xdmf", "w") as file:
            #      file.write_mesh(mesh)
            #      file.write_function(fem_function_alpha , tmp_cycle)    
            # with XDMFFile(mesh.comm, "./18_05_24/fase_6/fem_function_array_rdot.xdmf", "w") as file:
            #     file.write_mesh(mesh)
            #     file.write_function(fem_function_array_rdot , tmp_cycle)    
            # with XDMFFile(mesh.comm, "./18_05_24/fase_6/fem_function_array_psi.xdmf", "w") as file:
            #     file.write_mesh(mesh)
            #     file.write_function(fem_function_array_psi , tmp_cycle)    
            # with XDMFFile(mesh.comm, "./18_05_24/fase_6/fem_function_array_error.xdmf", "w") as file:
            #     file.write_mesh(mesh)
            #     file.write_function(fem_function_array_error , tmp_cycle)    
           ...
           # print("Sigma_bar:", sigma_bar_i)
            ...
            print("#-------------------------------------------------------------------------------------------------")
    with XDMFFile(mesh.comm, "./18_05_24/fase_6/fem_function_modulo.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_modulo_E_f , tmp_cycle)    
    with XDMFFile(mesh.comm, "./18_05_24/fase_6/fem_function_densidad_material.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_densidad_material , tmp_cycle)    
    with XDMFFile(mesh.comm, "./18_05_24/fase_6/fem_function_BVTV.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_BVTV , tmp_cycle)    
    with XDMFFile(mesh.comm, "./18_05_24/fase_6/fem_function_array_modulo.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_modulo_E_f , tmp_cycle)    
    with XDMFFile(mesh.comm, "./18_05_24/fase_6/fem_function_array_vm.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_array_vm , tmp_cycle)    
    with XDMFFile(mesh.comm, "./18_05_24/fase_6/fem_function_array_damage.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_damage , tmp_cycle)    
    with XDMFFile(mesh.comm, "./18_05_24/fase_6/fem_function_alpha.xdmf", "w") as file:
         file.write_mesh(mesh)
         file.write_function(fem_function_alpha , tmp_cycle)    
    with XDMFFile(mesh.comm, "./18_05_24/fase_6/fem_function_array_rdot.xdmf", "w") as file:
        file.write_mesh(mesh)
    ...
    with XDMFFile(mesh.comm, "./18_05_24/fase_6/fem_function_array_error.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_array_error , tmp_cycle)    
    with XDMFFile(mesh.comm, "./18_05_24/fase_6/fem_function_densidad_fase_6.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_densidad_gr_cm3 , tmp_day)
    with XDMFFile(mesh.comm, "./18_05_24/fase_6/fem_function_BVTV_fase_6.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_BVTV , tmp_day)
#-------------------------------------------------------------------------------------------
...
#-------------------------------------------------------------------------------------------
    ...
    for dday in range(1, 65):  # Ciclo externo con dtime va de 1 a 96
        ...
        for cycle in range(1000, 10001, 1000):  # Ciclo interno va de 1000 en 1000 hasta 10000
            ...
            expression_array_dot_vb =  (1 - array_porosidad) * array_derivative_NBMU * escalar_tmp_af7 * t_prima_100_TR_TI_TF/escalar_TF
            ...
            # Aplica el cambio de volumen solo si la fracción de volumen óseo supera un umbral
            array_BVTV[condicion_trabecular] = array_BVTV[condicion_trabecular] + array_derivative_NBMU[condicion_trabecular]/escalar_TF
            array_BVTV[condicion_cortical] += expression_array_dot_vb[condicion_cortical]
...
#            array_modulo_E_f[condicion_cortical]= 84370 * (array_BVTV[condicion_cortical] ** 2.58) * (array_alpha ** 2.74) *1e3
            ...
            # ----------------------------------------------------------------------------------------------------------
            # with XDMFFile(mesh.comm, "./18_05_24/fase_7/fem_function_array_modulo.xdmf", "w") as file:
            #     file.write_mesh(mesh)
            #     file.write_function(fem_function_modulo_E_f , tmp_cycle)    
            
            # with XDMFFile(mesh.comm, "./18_05_24/fase_7/fem_function_array_damage.xdmf", "w") as file:
            #     file.write_mesh(mesh)
            #     file.write_function(fem_function_damage , tmp_cycle)    
            # with XDMFFile(mesh.comm, "./18_05_24/fase_2/fem_function_alpha.xdmf", "w") as file:
            #     file.write_mesh(mesh)
            #     file.write_function(fem_function_alpha , tmp_cycle)    
            # with XDMFFile(mesh.comm, "./18_05_24/fase_7/fem_function_array_rdot.xdmf", "w") as file:
            #     file.write_mesh(mesh)
            #     file.write_function(fem_function_array_rdot , tmp_cycle)    
            # with XDMFFile(mesh.comm, "./18_05_24/fase_7/fem_function_array_psi.xdmf", "w") as file:
            #     file.write_mesh(mesh)
            #     file.write_function(fem_function_array_psi , tmp_cycle)    
            # with XDMFFile(mesh.comm, "./18_05_24/fase_7/fem_function_array_error.xdmf", "w") as file:
            #     file.write_mesh(mesh)
            #     file.write_function(fem_function_array_error , tmp_cycle)    
    ...
    with XDMFFile(mesh.comm, "./18_05_24/fase_7/misses_.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(sigma_vm_h , dday)
    with XDMFFile(mesh.comm, "./18_05_24/fase_7/displacements_.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(uh_in, dday)
    # with XDMFFile(mesh.comm, "./18_05_24/fase_7/sigma_.xdmf", "w") as file:
    #     file.write_mesh(mesh)
    #     file.write_function(valor_sigma , dday)
    with XDMFFile(mesh.comm, "./18_05_24/fase_7/fem_function_modulo.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_modulo_E_f , tmp_cycle)    
    with XDMFFile(mesh.comm, "./18_05_24/fase_7/fem_function_densidad_material.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_densidad_material , tmp_cycle)    
    with XDMFFile(mesh.comm, "./18_05_24/fase_7/fem_function_BVTV.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_BVTV , tmp_cycle)    
    with XDMFFile(mesh.comm, "./18_05_24/fase_7/fem_function_array_modulo.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_modulo_E_f , tmp_cycle)    
    with XDMFFile(mesh.comm, "./18_05_24/fase_7/fem_function_array_vm.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_array_vm , tmp_cycle)    
    with XDMFFile(mesh.comm, "./18_05_24/fase_7/fem_function_array_damage.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_damage , tmp_cycle)    
    with XDMFFile(mesh.comm, "./18_05_24/fase_7/fem_function_alpha.xdmf", "w") as file:
         file.write_mesh(mesh)
         file.write_function(fem_function_alpha , tmp_cycle)    
    with XDMFFile(mesh.comm, "./18_05_24/fase_7/fem_function_array_rdot.xdmf", "w") as file:
        file.write_mesh(mesh)
    ...
    with XDMFFile(mesh.comm, "./18_05_24/fase_7/fem_function_array_error.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_array_error , tmp_cycle)    
    with XDMFFile(mesh.comm, "./18_05_24/fase_7/fem_function_densidad_fase_7.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_densidad_gr_cm3 , tmp_day)
    with XDMFFile(mesh.comm, "./18_05_24/fase_7/fem_function_BVTV_fase_7.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_BVTV , tmp_day)
...
# ---------------------------------------------------------------------------------
    ...
    for dday in range(1, 25):  # Ciclo externo con dtime va de 1 a 24
        ...
        for cycle in range(1000, 10001, 1000):  # Ciclo interno va de 1000 en 1000 hasta 10000
            ...
            expression_array_dot_vr = (1 - array_porosidad) * array_derivative_NBMU * escalar_tmp_ar1 * (t_prima_24 /escalar_TR)**2 *t_prima_24/escalar_TR
            fem_function_vr_dot.x.array[:] = expression_array_dot_vr
            ...
            array_vm[condicion_trabecular] = (escalar_vm * array_COPY_BVTV[condicion_trabecular] + escalar_vm * array_formacion_vb[condicion_trabecular] - escalar_vm * array_derivative_NBMU[condicion_trabecular]/escalar_TR)/array_BVTV[condicion_trabecular]
            array_vm[condicion_cortical] = (escalar_vm * array_COPY_BVTV[condicion_cortical] + escalar_vm * expression_array_dot_vr[condicion_cortical])/array_BVTV[condicion_cortical]
            ...
            # Definir la expresión de sigma utilizando la función actual uh2_in
            sigma_expr = sigma(uh2_in)

# Proyectar sigma en el espacio de funciones tensoriales
           ...
           # print("Energía de deformación total:", energy)
           # print("Sigma_bar:", sigma_bar_i)
    with XDMFFile(mesh.comm, "./18_05_24/fase_8/misses_.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(sigma_vm_h , dday)
    with XDMFFile(mesh.comm, "./18_05_24/fase_8/displacements_.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(uh_in, dday)
    with XDMFFile(mesh.comm, "./18_05_24/fase_8/sigma_.xdmf", "w") as file:
         file.write_mesh(mesh)
         file.write_function(sigma_field , dday)
    with XDMFFile(mesh.comm, "./18_05_24/fase_8/fem_function_modulo.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_modulo_E_f , tmp_cycle)    
    with XDMFFile(mesh.comm, "./18_05_24/fase_8/fem_function_densidad_material.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_densidad_material , tmp_cycle)    
    with XDMFFile(mesh.comm, "./18_05_24/fase_8/fem_function_BVTV.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_BVTV , tmp_cycle)    
    with XDMFFile(mesh.comm, "./18_05_24/fase_8/fem_function_array_modulo.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_modulo_E_f , tmp_cycle)    
    with XDMFFile(mesh.comm, "./18_05_24/fase_8/fem_function_array_vm.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_array_vm , tmp_cycle)    
    with XDMFFile(mesh.comm, "./18_05_24/fase_8/fem_function_array_damage.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_damage , tmp_cycle)    
    with XDMFFile(mesh.comm, "./18_05_24/fase_8/fem_function_alpha.xdmf", "w") as file:
         file.write_mesh(mesh)
         file.write_function(fem_function_alpha , tmp_cycle)    
    with XDMFFile(mesh.comm, "./18_05_24/fase_8/fem_function_array_rdot.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_array_rdot , tmp_cycle)    
    with XDMFFile(mesh.comm, "./18_05_24/fase_8/fem_function_array_psi.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_array_psi , tmp_cycle)    
    with XDMFFile(mesh.comm, "./18_05_24/fase_8/fem_function_array_error.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_array_error , tmp_cycle)    
    with XDMFFile(mesh.comm, "./18_05_24/fase_8/fem_function_densidad_fase_7.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_densidad_gr_cm3 , tmp_day)
    with XDMFFile(mesh.comm, "./18_05_24/fase_8/fem_function_BVTV_fase_7.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_BVTV , tmp_day)        
    with XDMFFile(mesh.comm, "./18_05_24/fase_8/fem_function_densidad_fase_8.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_densidad_gr_cm3 , tmp_day)
    with XDMFFile(mesh.comm, "./18_05_24/fase_8/fem_function_BVTV_fase_8.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_BVTV , tmp_day)
    print(f"El valor promedio de daño:{promedios_damage[escalar_contador_total_dias]}")
    print(f"El valor promedio de la densidad:{promedios_rho_cortical_gr_cm_3[escalar_contador_total_dias]}")
    print(f"El valor promedio de la fracción de volumen:{promedios_BVTV[escalar_contador_total_dias]}")
    print(f"8.{dday} - El valor promedio del modulo de elasticidad:{promedios_modulo_elasticidad[escalar_contador_total_dias]}")
    print(f" Finalizo la primera etapa -->> La energía: {escalar_energy[escalar_contador_total_dias]}")
...
data.to_csv('./18_05_24/resultados_promedio_final.csv', index=False)
